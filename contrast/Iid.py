...
#读取数据
IID = 'C:/Users/zhu18/Desktop/CLS/contrast/fedavgIID.txt'
Non_IID = 'C:/Users/zhu18/Desktop/CLS/contrast/fedavgNon-IID.txt'


b = np.loadtxt(IID, usecols=4)
x = b[:, 2]
y2 = b
c = np.loadtxt(Non_IID, usecols=4)
y3 = c
