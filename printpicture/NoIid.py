...
plt.ylabel('Accuracy')
plt.title('Non-IID', size=15, loc='center')
# plt.ylabel('loss')
...
#读取数据
centralFile = 'C:/Users/zhu18/Desktop/CLS/printpicture/dp0.2Non-IIDCentro.txt'
fedFile = 'C:/Users/zhu18/Desktop/CLS/printpicture/dp0.2Non-IIDFedAvg.txt'
blockchainFile = 'C:/Users/zhu18/Desktop/CLS/printpicture/dp0.2Non-IIDOurMethod.txt'
...
# plt.plot(x, y1, color='blue', linewidth=1.0, marker="*"，linestyle='-')
